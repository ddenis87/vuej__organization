    ...
    axios
      ...
      .catch(err => {
        ...
        state.commit('SET_LIST_DATA', {
          ...
          clear: true,
          data: [
            {id: '1', institution_code: '2', title: 'Test organisations 1', inn: '1111111', egrul_status: 1},
            {id: '2', institution_code: '3', title: 'Test organisations 2', inn: '1111112', egrul_status: 1},
            {id: '3', institution_code: '4', title: 'Test organisations 3', inn: '1111113', egrul_status: 1},
            {id: '4', institution_code: '5', title: 'Test organisations 4', inn: '1111114', egrul_status: 1},
          ],
        });
      })
      .finally(() => state.commit('SET_IS_DATA_LOAD'));
